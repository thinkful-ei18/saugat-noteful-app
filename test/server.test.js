'use strict';
const app = require('../server'); //Require the express app that has all the routes
const chai = require('chai'); //Require Chai library
const chaiHttp = require('chai-http'); // Require Chai http which allows us to test HTTP apps
